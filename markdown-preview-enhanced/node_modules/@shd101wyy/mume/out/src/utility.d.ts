 ...
 */
export declare function parseAttributes(text?: string, asArray?: boolean): {};
/**
 * Convert JSON object to attributes string.
 * @param obj
 */
export declare function stringifyAttributes(obj: object, addCurlyParen?: boolean): string;
/**
